  ...
  return (
    ...
    >
      <span className="flex min-w-0 flex-col gap-1">
        <span className="font-serif text-lead font-medium text-foreground decoration-1 underline-offset-[5px] group-hover:underline">
          {post.title}
        </span>
        {post.description && (
          <span className="line-clamp-2 max-w-xl text-ui text-muted-foreground sm:line-clamp-1">
            {post.description}
          </span>
        )}
      </span>
