      ...
      <Container className="py-12">
        <div className="flex flex-col gap-3">
          ...
          <a
            ...
            className="mono w-fit text-[13px] text-muted-foreground underline decoration-1 decoration-border underline-offset-[5px] transition-colors hover:text-foreground hover:decoration-foreground"
          >
            {site.email}
          </a>
        </div>
